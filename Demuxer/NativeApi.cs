...
{
    [LibraryImport("NativeDemuxer.dll", EntryPoint = "create_demuxer")]
    ...
    [LibraryImport("NativeDemuxer.dll", EntryPoint = "delete_frame_buffer")]
    internal static partial void DeleteFrameBuffer(IntPtr buffer);

    [LibraryImport("NativeDemuxer.dll", EntryPoint = "delete_demuxer")]
